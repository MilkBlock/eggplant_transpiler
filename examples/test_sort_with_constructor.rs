...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let commands =
        parser.get_program_from_string(Some("sort_with_constructor.egg".to_string()), program)?;
    ...
    let eggplant_commands =
        convert_to_eggplant_with_source(&commands, Some("sort_with_constructor.egg".to_string()));
    ...
    info!("Generated code saved to: generated/sort_with_constructor_generated.rs");
