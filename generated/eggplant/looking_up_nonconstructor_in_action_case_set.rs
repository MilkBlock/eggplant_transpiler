...
// Source: examples/looking_up_nonconstructor_in_action_case_set.egg:2
...
fn main() {
    env_logger::init();
    // Source: examples/looking_up_nonconstructor_in_action_case_set.egg:1
    tx_rx_vt_pr!(MyTx, MyPatRec);
    
    // Source: examples/looking_up_nonconstructor_in_action_case_set.egg:3
